...
class Game:
    ...
    LAYOUTS = ["0-1-o,1-1-o,2-2-x,3-3-x,4-2-x,5-2-x,6-3-x,7-1-x,16-1-o,17-3-o,18-2-o,19-2-o,20-3-o,21-2-o,22-1-x,23-1-x", # prime against prime layout
               ...
               "0-15-o,23-15-x"] # one stack layout
    NUMCOLS = 24
    QUAD = 6
    OFF = 'off'
    ON = 'on'
